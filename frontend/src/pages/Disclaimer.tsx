          ...
          <div className="space-y-6 text-gray-700 dark:text-gray-300">
            <section className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg p-6">
              ...
              <p className="text-red-800 dark:text-red-200">
                Pilimarket is a virtual forecasting platform for entertainment and educational purposes only. 
            ...
            <section>
              ...
              <p>
                Pilimarket operates using virtual, non-redeemable chips that cannot be converted to real money, 
            ...
            <section>
              ...
              <p>
                The information, forecasts, and market data provided on Pilimarket are for entertainment purposes only 
            ...
            <section>
              ...
              <p>
                Market outcomes are determined based on verifiable real-world events. However, Pilimarket makes no 
            ...
            <section>
              ...
              <p>
                Pilimarket is provided "as is" without any warranties, express or implied. We do not guarantee that 
            ...
            <section>
              ...
              <p>
                To the fullest extent permitted by law, Pilimarket and its operators shall not be liable for any direct, 
            ...
            <section>
              ...
              <p>
                Pilimarket is intended for users who are 18 years of age or older. By using the platform, you represent 
            ...
            <section>
              ...
              <p>
                Users are responsible for ensuring their use of Pilimarket complies with all applicable local, state, 
                national, and international laws and regulations. Pilimarket operates in accordance with Philippine laws 
                and regulations.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                We reserve the right to modify, suspend, or discontinue any aspect of Pilimarket at any time without 
            ...
            <section className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6">
              ...
              <p className="text-yellow-800 dark:text-yellow-200">
                By using Pilimarket, you acknowledge that you have read, understood, and agree to be bound by this 
