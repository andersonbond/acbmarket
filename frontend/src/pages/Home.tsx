        ...
        setMarkets([
          {
            ...
            outcomes: [
              { id: '1', name: 'Yes', total_points: 35000, percentage: 65 },
              { id: '2', name: 'No', total_points: 19000, percentage: 35 },
            ],
            total_volume: 54000,
          },
          {
            ...
            created_at: new Date().toISOString(),
            outcomes: [
              { id: '3', name: 'Yes', total_points: 28000, percentage: 72 },
              { id: '4', name: 'No', total_points: 11000, percentage: 28 },
            ],
            total_volume: 39000,
          },
          {
            ...
            created_at: new Date().toISOString(),
            outcomes: [
              { id: '5', name: 'Yes', total_points: 12000, percentage: 25 },
              { id: '6', name: 'No', total_points: 36000, percentage: 75 },
            ],
            total_volume: 48000,
          },
          {
            ...
            created_at: new Date().toISOString(),
            outcomes: [
              { id: '7', name: 'Yes', total_points: 8000, percentage: 15 },
              { id: '8', name: 'No', total_points: 45000, percentage: 85 },
            ],
            total_volume: 53000,
          },
          {
            ...
            created_at: new Date().toISOString(),
            outcomes: [
              { id: '9', name: 'Yes', total_points: 32000, percentage: 68 },
              { id: '10', name: 'No', total_points: 15000, percentage: 32 },
            ],
            total_volume: 47000,
          },
        ]);
